...
<body>
    <nav>
        ...
        <div class="nav-section">
            ...
            <div class="menubar space">
                <ul>
                    <li><a href="#" class="down">Dashboard <img src="icons/arrow-down.png" class="dd" alt="arrowdown"></a>
                        <ul class="dropdown">
                    ...
                    <li><a href="#"><img src="icons/account.png" alt="person"></a></li>
                </ul>
            </div>
        </div>
    </nav>
    <section>
        <div class="container">
            ...
            <div class="block3">
                <div class="scrollbar">
                    <h3 class="block-title space">Critical Inventory Levels</h3>
