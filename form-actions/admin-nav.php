        ...
        <div class="nav-section">
            ...
            <div class="menubar space" id="menubar">
                <ul class="margin-top">
                    ...
                    <li><a href="../admin-db.php" class="down no">Dashboard </a><img src="../icons/arrow-down.png" class="dd" id="dd" alt="arrowdown">
                    ...
                    <li><a href="admin-account-update.php"><img src="../icons/account.png" id="profile" alt="person"></a></li>
                </ul>
            </div>
