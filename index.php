    ...
    <div class="container" id="main">
        <div class="log-in">
            <form action="loginaction.php" method="post">
                ...
                <button type="submit" name="push">Login</button>
            </form>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-left">
                    ...
                    <h4>Have an account already?<button id="lipat-right">Sign in</button></h4>
                </div>
                <div class="overlay-right">
                    <img src="images/logo.png" alt="#">
                    <h4>Create account?<button id="lipat-left">Sign up</button></h4>
                </div>
            </div>
        </div>
    </div>
